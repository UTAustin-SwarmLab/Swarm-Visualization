...
def test_basic_scatterplot(x_data,y_data) -> None:
    ...
    # Save the plot
    save_loc = os.path.join(example_plot_folder_loc,"scatterplots", 'basic_scatterplot.png')
...
def test_scatter_pdf_plot(x_data,y_data) -> None:
    ...
    # Save the plot
    save_loc = os.path.join(example_plot_folder_loc,"scatterplots", 'scatter_pdf_plot.png')
    save_fig(fig,save_loc,dpi = 600)
